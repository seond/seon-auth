...
var authorizedClientIds = ['simplelist', 'papers3-mac'];
...
OAuthClientsSchema.static('getClient', function(clientId, clientSecret, callback) {
  ...
  OAuthClientsModel.findOne(params, function(err, client){console.log(err);console.log(client);callback(err, client)});
});
